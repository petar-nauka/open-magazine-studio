...
describe('buildTocEntries', () => {
  it('lists only articles, in order, with anchor + thumbnail', () => {
    const items: RenderItem[] = [
      { kind: 'article', id: 'a1', doc: { title: 'Първа', author: '', accent: 'teal', openerImage: 'p1.jpg', blocks: [] } },
      { kind: 'insert', id: 'ad1', imageUrl: 'ad.jpg' },
      { kind: 'article', id: 'a2', doc: { title: 'Втора', author: '', accent: 'gold', openerImage: undefined, blocks: [] } },
    ];
