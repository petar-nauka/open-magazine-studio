...
describe('buildTocEntries', () => {
  it('lists only articles, in order, with anchor + thumbnail', () => {
    const items: RenderItem[] = [
      { kind: 'article', id: 'a1', doc: { title: 'Първа', author: '', accent: 'teal', align: 'justify', openerImage: 'p1.jpg', dropCap: true, blocks: [] } },
      { kind: 'insert', id: 'ad1', imageUrl: 'ad.jpg' },
      { kind: 'article', id: 'a2', doc: { title: 'Втора', author: '', accent: 'gold', align: 'justify', openerImage: undefined, dropCap: true, blocks: [] } },
    ];
